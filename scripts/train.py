def train_go1(headless=True):
    ...
    if args.terrain == "plane":
        ...
        Cfg.terrain.terrain_length = 6.0
        ...
        Cfg.terrain.top.pyramid_num_x=3
        Cfg.terrain.top.pyramid_num_y=3
        ...
        Cfg.terrain.bottom.pyramid_num_x=5
        Cfg.terrain.bottom.pyramid_num_y=4
