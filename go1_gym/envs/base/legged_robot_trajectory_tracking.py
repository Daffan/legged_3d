...
class LeggedRobot(BaseTask):
    ...
    def update_curriculum(self):
        ...
        if self.cfg.curriculum_thresholds.cl_fix_target and \
            ...
            # This curriculum gradually move the target distance to the goal
            ...
            # once the current target distance reaches the success threshold, we reset the reached buffer
    ...
    def _plan_target_pose(self, env_ids):
        ...
        if self.cfg.commands.sampling_based_planning:
            ...
            # no planning, directly use the global goal location
    ...
    def _create_envs(self):
        ...
        for i in range(self.num_envs):
            ...
            # add walls
            # we abondoned this code block becuase the walls are represented as part of the terrain mesh now
